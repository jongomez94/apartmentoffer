 ...
 * Update copy, prices, and links here.
 */
...
export const hero = {
  ...
  // Video: add your video URL or path here when ready
  videoSrc: "", // e.g. "/hero-video.mp4" or external URL
} as const;
...
export const dailyExperience = {
  title: "A day in the mountains",
  morning: {
    title: "Morning",
    description: "Fresh air. Birds at first light. The calm energy of sunrise before the world wakes.",
  },
  midday: {
    title: "Midday",
    description: "Remote work with peaceful surroundings. Focus comes easily when the only noise is the wind.",
  },
  evening: {
    title: "Evening",
    description: "Sunset views from your window. Quiet. Stillness. A natural end to the day.",
  },
} as const;
...
/** Gallery images from public/gallery. Filenames are URL-encoded for paths with spaces. */
...
/** Video from public/Experience the Space/ */
export const videoSection = {
  title: "Experience the Space",
  videoUrl: "/Experience%20the%20Space/Video%20for%20Experience%20the%20Space.mp4",
  placeholder: false,
} as const;
