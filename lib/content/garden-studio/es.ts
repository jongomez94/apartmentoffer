...
export const gardenStudioEs: GardenStudioContent = {
  ...
  space: {
    ...
    features: [
      ...
      "Pensado para trabajo, descanso y retiros breves",
  ...
  finalCta: {
    headline: "Pregunta por el Estudio del Jardín",
    subheadline:
      "Te compartimos disponibilidad, orientación y cómo encaja junto a la oferta del apartamento.",
    ctaText: "Escríbenos",
  },
