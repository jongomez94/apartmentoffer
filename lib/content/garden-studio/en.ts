...
export const gardenStudioEn: GardenStudioContent = {
  ...
  metaDescription:
    "A creative garden retreat at Casa Portal de la Montaña for focused work, rest, and immersion in nature near San Salvador.",
  hero: {
  ...
  space: {
    title: "The space",
    intro:
      "A dedicated studio footprint in the garden with natural light, room to work and rest, and the same sanctuary energy as the rest of the property.",
    features: [
